...
class Profile{
    ...
    public function __construct(String $profileID,String $user,String $previousTransactions){
    ...
    public function __toString():String{
        return "ProfileID: " . $this->profileID . ", CustID: " . $this->user . ", Previous Transaction: " . $this->previousTransactions;
    }
